...
const addMovement = document.getElementById("fab-add-movement");
...
addMovement.addEventListener("click", (event) => {
  console.log("click");
  if (movementForm.style.visibility === "hidden") {
    movementForm.style.visibility = "visible";
  }
});

const closeBtn = document.getElementById("button-back");

closeBtn.addEventListener("click", (event) => {
  movementForm.style.visibility = "hidden";
});
